...
urlpatterns = [
    ...
    path('campsite/<int:campsite_id>/book/', views.create_booking, name='create_booking'), # 予約作成ビューのURL
    path('booking/<int:booking_id>/', views.booking_detail, name='booking_detail'), # 予約詳細ビューのURL
